...
import logo from "../../assets/logo/zeureCropped.png";
import logo2 from "../../assets/logo/zeureTraFinal.png";
...
import { Heading } from "../../theme/TextStyles.jsx";
          ...
          <div className="flex items-center justify-between  py-4 px-6 lg:px-16">
            ...
            <div className="flex items-center md:space-x-3">
              ...
              <ul className="hidden space-x-3 md:flex">
                      ...
                      <button
                        ...
                        className={`${
                          ...
                          location.pathname === "/customer/login"
                            ? "text-primary"
                            : null
                        } flex items-center space-x-0.5 transition duration-200 ease-in-out hover:text-secondary`}
                      >
                        <span>Account</span>
                        <IoIosArrowDown />
                      </button>
                ...
                <li className="font-urbanist font-bold text-zinc-600 transition duration-200 ease-in-out hover:text-secondary">
                  <NavLink
                    onClick={() => {
                      if (dropdown) {
                        handleDropdown();
                ...
                {/* <li>
                  <Heading color="secondary">Hello</Heading>
                </li> */}
                <li className="font-urbanist font-bold text-zinc-600 transition duration-200 ease-in-out hover:text-secondary">
                  <NavLink
                    onClick={() => {
